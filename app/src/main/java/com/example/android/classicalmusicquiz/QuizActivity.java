...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO (1): Create a method to initialize the MediaSession. It should create the
    ...
    // TODO (2): Create an inner class that extends MediaSessionCompat.Callbacks, and override the
        // onPlay(), onPause(), and onSkipToPrevious() callbacks. Pass an instance of this class
