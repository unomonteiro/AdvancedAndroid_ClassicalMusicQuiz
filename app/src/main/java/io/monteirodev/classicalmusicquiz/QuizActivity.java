...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    // TODO (1): Create a static inner class that extends Broadcast Receiver and implement the
        // onReceive() method.
    //TODO (2): Call MediaButtonReceiver.handleIntent and pass in the incoming intent as well as the
